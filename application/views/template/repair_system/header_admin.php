						...
						<li class="dropdown user user-menu">
							...
							<ul class="dropdown-menu">
								...
								<li class="user-footer">
									...
									<a href="<?php // echo site_url('');?>" class="btn btn-primary btn-flat">โปรไฟล์</a>

										<a href="<?php echo site_url('login/logout'); ?>"
											onclick="return confirm('คุณต้องการออกจากระบบหรือไม่!!!');" class="btn btn-danger btn-flat">
										ออกจากระบบ</a>
									</div>
								</li>
		...
		<aside class="main-sidebar">
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					<li class="header">เมนู_as</li>
					<li><a href="<?= site_url('repair_system/admin'); ?>"><i class="fa fa-home"></i> <span>หน้าหลัก</span></a></li>
					<li><a href="<?= site_url('repair_system/repair'); ?>"><i class="fa fa-wrench"></i>
							<span>แจ้งซ่อม</span></a></li>
					<li><a href="<?= site_url('repair_system/admin/admin_list'); ?>"><i class="fa fa-check-square"></i> <span>รายการแจ้งซ่อม</span></a></li>
					<li class="header">ตั้งค่า</li>
					<li><a href="<?= site_url('admin_repair'); ?>"><i class="fa fa-home"></i> <span>จัดการสมาชิก</span></a></li>
					<li><a href="<?= site_url('Admin_employee'); ?>"><i class="fa fa-home"></i> <span>จัดการอุปกรณ์</span></a>
					</li>
					<li><a href="<?= site_url('Admin_employee'); ?>"><i class="fa fa-home"></i> <span>จัดการอาคาร</span></a></li>

					<li><a href="<?= site_url('login/logout'); ?>" onclick="return confirm('do you want to logout ?');"><i
								class="fa fa-edit"></i> <span>ออกจากระบบ</span></a></li>
				</ul>
			</section>
			<!-- /.sidebar -->
		</aside>
